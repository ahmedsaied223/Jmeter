...
export http_proxy="http://r-svc-fwproxy.altcon-slack-common.svc.cluster.local:3128"
export https_proxy="http://r-svc-fwproxy.altcon-slack-common.svc.cluster.local:3128"

./bin/jmeter -n -t /test-tools/oom-sports/jmeter/CC_OOMS_Smoke_Test_AMR-1.18.jmx -l /test-tools/ooms_result.csv 

# waiting until the test finishes 
sleep 120

python /test-tools/oom-sports/jmeter/notify_slack.py
